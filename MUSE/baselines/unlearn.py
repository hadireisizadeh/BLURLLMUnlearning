...
def main():
    ...
    if args.algo == 'kn':
        ...
        if "Pen" in args.algo:
            unlearn_method = "Pen"
        elif "BLO_forget_lower" in args.algo:
            unlearn_method = "BLO_forget_lower"
        elif "BLO_forget_upper" in args.algo:
            unlearn_method = "BLO_forget_upper"
